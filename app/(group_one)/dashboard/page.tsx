...
export default async function Dashboard(){
  ...
  return <>
    ...
    <section className="columns-1 md:columns-2 lg:columns-3 gap-6 p-4">
      ...
      <article className="break-inside-avoid today_appointment">
        <DashboardClients rules={rules.today_appointment} />
      </article>
      <article className="break-inside-avoid upcoming_appointments">
        <DashboardClients rules={rules.future_appointments} />
      </article>
      <article className="break-inside-avoid follow_up">
        <DashboardClients rules={rules.follow_up} />
      </article>

      <article className="break-inside-avoid pending_callback">
